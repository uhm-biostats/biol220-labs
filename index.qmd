...
Each item listed under "All Projects" is a "Project" within the lab01-00# Workspace. Each week I will create a Project template that you will copy and work from (you cannot edit the original). 

4. To create your own, click "START" to the left of "lab01".

![](images/rstudio-cloud-10.png)

5. Once the Project is copied and deployed, rename the Project from "lab01" to include your name like this: 
